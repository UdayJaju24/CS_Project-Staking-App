// import {Stack, Text, useToast, SimpleGrid, Box, Card, Flex, Heading, Input, Skeleton } from '@chakra-ui/react'
// import { Web3Button, useAddress, useContract, useContractRead, useTokenBalance } from '@thirdweb-dev/react'
// import React, {useEffect, useState} from 'react'
// import { ethers } from 'ethers'
// import { STAKE_TOKEN_ADDRESSES, REWARD_TOKEN_ADDRESSES, STAKE_CONTRACT_ADDRESSES } from '../constants/addresses'


// export default function Stake() {

//     const address = useAddress(); // Hook for accessing the address of the connected wallet
...
//     } = useContractRead(
//         stakeContract, "getStakeInfo", [address])


//         useEffect(()=>{
//             setInterval(() => {
//                 refetchStakeInfo();
//             }, 10000); // this is the time interval to refetch
//         },[]);
...
//         const toast = useToast(); // to display a success toast

//         return (
//             <Card p={5} mt={10}>
//                 <Heading>Earn Reward Money</Heading>
